package com.mo.assemnt.online_retail_store.service;
...
import com.mo.assemnt.online_retail_store.controller.CustomException;
...
import com.mo.assemnt.online_retail_store.dataaccess.repository.BillRepository;
import com.mo.assemnt.online_retail_store.dataaccess.repository.LineItemRepository;
import com.mo.assemnt.online_retail_store.dataaccess.repository.ProductRepository;
...
public class BillService {
	...
	private Bill addProductToBill(Long billId, String barCodeId, int quantity) {
		Bill o1 = billRepo.findById(billId).orElse(new Bill());
	...
	public Bill updateBill(BillUpdateInfo billUpdateInfo, Long billId) {
		...
		Bill bill = billRepo.findById(billId).orElse(new Bill());
